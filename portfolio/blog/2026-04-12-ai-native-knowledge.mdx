...
<div style={{marginBottom: '1.25rem'}}>
  <img
    src="/img/ai-native-knowledge/main_image-1200.webp"
    srcSet="/img/ai-native-knowledge/main_image-800.webp 800w, /img/ai-native-knowledge/main_image-1200.webp 1200w, /img/ai-native-knowledge/main_image.webp 1536w"
    sizes="(max-width: 996px) 100vw, 768px"
    width={1536}
    height={1024}
    alt='A confused robot standing among toppled Confluence, Jira, Slack, and Notion blocks amid error messages — the reality of "going AI native" on top of scattered knowledge.'
    loading="eager"
    fetchPriority="high"
