...
Chrome. Or use the hosted demo: **[MCP client demo](https://windowai.danduh.me/mcp-client)**
(its [API walkthrough](https://windowai.danduh.me/mcp-client/docs) has the full protocol).
...
- [MCP Client API reference](https://windowai.danduh.me/mcp-client/docs) — the hosted walkthrough of the connect flow and the CORS rules.
