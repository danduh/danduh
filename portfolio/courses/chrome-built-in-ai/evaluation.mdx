...
:::tip Try it
Run it locally: open `16-evaluation/index.html` from the [chrome-ai-course repo](https://github.com/danduh/chrome-ai-course) in desktop Chrome. Or use the hosted demo: **[the mini-eval harness](https://windowai.danduh.me/evaluation/evaluation-demo)** (with the [API walkthrough](https://windowai.danduh.me/evaluation/evaluation-api-documentation)).
