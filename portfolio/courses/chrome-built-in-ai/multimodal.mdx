...
Chrome. Or use the hosted demo: **[Multimodal on windowai.danduh.me](https://windowai.danduh.me/multimodal)**.

Expected: you drop, paste, or pick an image, type a question, and the answer streams in underneath — with nothing leaving the machine (open DevTools → Network and watch it stay silent). The hosted [API docs](https://windowai.danduh.me/multimodal/docs) walk the same calls.
